    ...
    <div class="container mt-5 shadow con">
        <div class="row align-items-stretch">
            ...
            <div class="col box-form rounded-end">
                ...
                <h2 class="text-center py-4">Restablecer contraseña</h2>
                <form action="" method="POST">
                    <div class="mb-2 col-md-8 mx-auto">
                        <label for="user" class="form-label">Digite su nombre de usuario</label>
                    ...
                    <div class="d-grid col-md-8 ingresa mx-auto mb-2">
                        <input type="submit" class="btn btn-primary" value="Enviar" name="change" id="enviar">
                    </div>
