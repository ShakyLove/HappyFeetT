...
<body>
    ...
    <section id="container">
        <div class="tabla-usuario">
            ...
            <div class="table">
                <table class="table-productos animate__animated animate__fadeInUp">
                    <tr>
                        ...
                        <th class="titulo-pro">Categoría</th>
                    ...
                    ?>
                            ...
                            <tr class="rol-<?php echo $clase ?>">
                                ...
                                ?>
                                    <td style="background: red; color: white;" class="titulo-pro animate__animated animate__flash animate_repeat-3"><?php echo $row['existencia']; ?></td>
                                <?php    } else { ?>
