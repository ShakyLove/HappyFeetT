                ...
                <div style="display: none; " class="containerData">
                    ...
                    <div style="width: 50%;" class="data-empresa"> 
                        ...
                        <form style="border: none;" action="" method="POST" name="frmEmpresa" id="frmEmpresa">
                            ...
                            <div>
                                <label for="">Nit:</label><input type="text" name="txtNit" id="txtNit"
                                placeholder="Nit de la empresa" value="" require>
                            </div>
                            <div>
                                <label for="">Nombre:</label><input type="text" name="txtNombre" id="txtNombre"
                                placeholder="Nombre de la empresa" value="" require>
                            </div>
                            <div>
                                <label for="">Télefono:</label><input type="text" name="txtTelEmpresa" id="txtTelEmpresa"
                                placeholder="Número de télefono" value="" require>
                            </div>
                            <div>
                                <label for="">Correo electrónico:</label><input type="text" name="txtEmailEmpresa" id="txtEmailEmpresa"
                                placeholder="Correo electrónico" value="" require>
                            </div>
                            <div>
                                <label for="">Dirección:</label><input type="text" name="txtDirEmpresa" id="txtDirEmpresa"
                                placeholder="Dirección de la empresa" value="" require>
                            </div>
