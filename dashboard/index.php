						...
						<div class="tabla2">
							...
							<table class="tabla-usuario1">
								<tr>
									...
									<th style="text-align: start;">Usuarios registrados</th>
									<?php 
										$query_sum = mysqli_query($conn, "SELECT COUNT(*) AS 'suma' FROM usuarios");
										$row = mysqli_fetch_array($query_sum);
									?>
									<th style="text-align: center;"><?php echo $row['suma'] ?></th>
								</tr>
							</table>
							...
							<table class="tabla-usuario2">
								<tr>
									...
									<th style="text-align: start;">Entradas de productos</th>
									<?php 
										$query_sum = mysqli_query($conn, "SELECT COUNT(*) AS 'suma1' FROM entrada");
										$row = mysqli_fetch_array($query_sum);
									?>
									<th style="text-align: center;"><?php echo $row['suma1'] ?></th>
								</tr>
							</table>
							...
							<table class="tabla-usuario3">
								<tr>
									...
									<th style="text-align: start;">Registro proveedores</th>
									<?php 
